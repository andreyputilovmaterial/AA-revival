...
def write_to_file(dataframes,out_filename):
    ...
    # excel_sheet_format.format_sheet_overview(overview_df)
    # excel_sheet_format.format_sheet_variables(variables_df)
    # excel_sheet_format.format_sheet_analysisvalues(categories_df)
    with pd.ExcelWriter(out_filename, engine='openpyxl') as writer:
        ...
        excel_sheet_format.format_sheet_overview(writer.sheets['Overview'])
        excel_sheet_format.format_with_stdstyles(writer.sheets['Variables'])
        excel_sheet_format.format_sheet_variables(writer.sheets['Variables'])
        excel_sheet_format.format_with_stdstyles(writer.sheets['Analysis Values'])
        excel_sheet_format.format_sheet_analysisvalues(writer.sheets['Analysis Values'])
        excel_sheet_format.format_with_stdstyles(writer.sheets['Validation Issues Log'])
        excel_sheet_format.format_sheet_validationissues(writer.sheets['Validation Issues Log'])
        excel_sheet_format.format_with_stdstyles(writer.sheets['MDD_Data_Variables'])
        excel_sheet_format.format_with_stdstyles(writer.sheets['MDD_Data_Categories'])
        # excel_sheet_format.format_with_stdstyles(writer.sheets['ValidationVariables'])
